...
triggerall = Var(13) = 1
triggerall = statetype = S
trigger1 = ctrl && enemynear,movetype = A && p2dist X < 120
trigger2 = stateno = 1090 && enemynear,movetype = A && p2dist X < 120
trigger3 = stateno = 52 && enemynear,movetype = A && p2dist X < 120
trigger4 = (stateno = 1030||stateno = 1035||stateno = 1040) && movehit && animelem = 2
;====================================================================
;			 Special Moves(A.I)
;====================================================================
;Asura Senkuu (Long Forward)
[State -1, Asura Senkuu (Long Forward)(A.I)]
type = ChangeState
value = 1050
triggerall = Var(13) = 1 && !winko
triggerall = statetype != A
trigger1 = enemynear,movetype = A && p2dist X <= 100 && backedgebodydist < 110 && ctrl && random <= 400
trigger2 = enemynear,numproj >= 1 && ctrl && random <= 600
trigger3 = P2dist X > 100 && ctrl && enemynear,movetype = A && random <= 600
;--------------------------------------------------------------------
...
trigger1 = statetype != A
trigger1 = ctrl
trigger1 = enemynear,movetype = A && p2dist X <= 100 && backedgebodydist >= 110
;--------------------------------------------------------------------
;Asura Senkuu (Short Forward)
...
triggerall = Var(13) = 1  & !winko
triggerall = statetype != A
trigger1 = ctrl && P2dist X <= 110 && enemynear,movetype = A
trigger2 = stateno = 1090 && P2dist X <= 110 && enemynear,movetype = A
trigger3 = P2Dist X < 110 && enemynear,Statetype = A && enemynear,movetype != A && ctrl && enemynear,movetype != H
trigger4 = P2Dist X < 110 && enemynear,Statetype = A && enemynear,movetype != A && ctrl && Var(14) <= 2 && enemynear, movetype = H
;--------------------------------------------------------------------
;Hyakki Shuu (Weak)
...
trigger2 = P2movetype = A && p2dist X <= 120 && ctrl && pos Y < -50
;--------------------------------------------------------------------
;Tenma Kujin Kyaku (Weak)
...
trigger1 = statetype = S && Stateno != 100
trigger1 = ctrl
trigger1 = P2dist X > 50 && enemynear,movetype != A && random > 400
;--------------------------------------------------------------------
;Run Back
[State -1, Run Back]
type = ChangeState
...
trigger1 = ctrl && enemynear,statetype != L
trigger1 = P2dist X > 100 && enemynear,movetype != A && random <= 400
trigger2 = statetype = S && Stateno != 40
trigger2 = ctrl && enemynear,statetype != L
trigger2 = P2dist X > 100 && enemynear,movetype != A && random <= 400
...
type = ChangeState
value = 315
triggerall = Var(13) = 1 && ctrl && !winko && statetype != A
...
trigger1 = statetype = S
trigger1 = ctrl && P2dist X <= 50 && enemynear, Movetype != A && random <= 500
trigger2 = stateno = 1090 && P2dist X <= 100 && random <= 500
;--------------------------------------------------------------------
;Stand Medium Punch
;--------------------------------------------------------------------
[State -1, Stand Medium Punch]
...
trigger1 = ctrl && enemynear,statetype = L && p2dist X <= 80
trigger2 = stateno = 100 && P2dist X <= 80 && enemynear, movetype != A && enemynear,statetype = C
trigger3 = stateno = 52 && P2dist X <= 80 && enemynear, movetype != A 
;--------------------------------------------------------------------
;Crouching Medium Kick
[State -1, Crouching Medium Kick]
type = ChangeState
...
[State -1, CrouchGuard]
type = ChangeState
triggerall = (Var(13) = 1) && (StateType != A) && (Pos Y >= 0) && (P2BodyDist Y <= 0)&& stateno != 131
...
[State -1, AirGuard]
type = ChangeState
triggerall = (Var(13) = 1) && (StateType = A) && (Pos Y < 0) && (P2BodyDist Y >= -120) && stateno != 132
